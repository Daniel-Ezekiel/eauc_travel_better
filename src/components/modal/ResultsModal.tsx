...
export const ResultsModal = ({
  ...
  return (
    <div className="fixed top-0 left-0 w-dvw h-dvh p-4 grid place-items-center bg-midnight/50 backdrop-blur-xs">
      ...
      <button type="button" className="absolute flex gap-2 items-center top-10 right-10 z-10 cursor-pointer font-medium text-midnight" onClick={handleClick}>
